package com.example.daniel.bluetoothraspberrypi3;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                while(!Thread.currentThread().isInterrupted())
                {
                    ...
                    try {
                        ...
                        if(bytesAvailable > 0)
                        {
                            ...
                            bytesAvailable = 0; // Solução para o travamento do app
                        }
                    } catch (IOException e) {
                        // TODO Auto-generated catch block
                        e.printStackTrace();
        ...
        submit = (Button) findViewById(R.id.simpleSwitch1);
        ...
        if(pairedDevices.size() > 0)
        {
            ...
            {
                if(device.getName().equals("raspberrypi")) //Nome do dispositivo Bluetooth ( Raspberry Pi 3)
                {
